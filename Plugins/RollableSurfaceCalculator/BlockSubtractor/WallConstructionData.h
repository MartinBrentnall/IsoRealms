...
class WallConstructionData {
   ...
   * construction data.
   * 
   * @param IRollableSurfaceProvider*  The provider for creating the wall.
   ...
   */
  IWallSurface* constructSurface(IRollableSurfaceProvider*, int, int, IWallSurface::FaceDirection);
};
