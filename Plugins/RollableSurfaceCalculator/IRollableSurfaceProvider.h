 ...
 */
#ifndef I_ROLLABLE_SURFACE_PROVIDER_H
#define I_ROLLABLE_SURFACE_PROVIDER_H
 ...
 */
class IRollableSurfaceProvider {
  public:
   ...
   */
  virtual std::vector<IRollableSurface*> getRollableSurfaces(IRollableSurface::FaceDirection) = 0;
   ...
   */
  virtual IRollableSurface* createSubSurface(IRollableSurface::FaceDirection, int, int, int, int) = 0;
