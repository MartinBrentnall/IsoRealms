...
void C64SpindizzySprite::setTexture(GLuint textureID, Direction direction) {
  cTextureID = textureID;
  cDirection = direction;
  cMapping = TILED;
}

void C64SpindizzySprite::setTexture(GLuint textureID, Mapping mapping) {
  cTextureID = textureID;
  cDirection = NORTH;
  cMapping = mapping;
}
...
ISpindizzyTexture::Mapping C64SpindizzySprite::getMapping() {
  return cMapping;
}
