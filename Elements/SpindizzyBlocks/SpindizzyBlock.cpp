...
ISpindizzyTextureSet::TextureType SpindizzyBlock::getEastWallTexture() {
  return ISpindizzyTextureSet::WALL_EAST;
}

ISpindizzyTextureSet::TextureType SpindizzyBlock::getSouthWallTexture() {
  return ISpindizzyTextureSet::WALL_SOUTH;
}

ISpindizzyTextureSet::TextureType SpindizzyBlock::getWestWallTexture() {
