...
SpindizzyGERALD::SpindizzyGERALD(ISpindizzyGERALDFactory* elementFactory, BlockLocation* startLocation, std::string const& modelPath, ICollectables* collectables, ICollidableSurfaceRegistry* collidableSurfaceRegistry, ILocationAwareness* locationAwareness, IZoneContext* zoneContext, ICamera* camera, float fallLimit, IScript* fallLimitScript, IScript* respawnScript, IProject* project, IRuntimeContext* runtimeContext) : Element<ISpindizzyGERALDSet, ISpindizzyGERALDFactory>(elementFactory) {
