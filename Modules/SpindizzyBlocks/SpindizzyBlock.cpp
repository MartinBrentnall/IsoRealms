...
SpindizzyBlock::SpindizzyBlock(ISpindizzyBlockType* elementType, BlockLocation* startLocation, BlockLocation* endLocation, SpindizzyBlockProperties* blockProperties, bool addition) : ISpindizzyBlock(elementType) {
...
SpindizzyBlock::SpindizzyBlock(ISpindizzyBlockType* elementType, DOMNodeWrapper* node) : ISpindizzyBlock(elementType) {
}

ITexture** SpindizzyBlock::getTileSurfaceTexture() {
  ISpindizzyBlockType* mType = getElementType();
  BlockTypeProperties* mBlockTypeProperties = mType->getBlockTypeProperties();
...
// TODO  ISpindizzyBlockSet* mSpindizzyBlockSet = getElementSet();
...
void SpindizzyBlock::save(DOMNodeWriter* node, IResourceLocator* resourceLocator, BlockLocation& zoneLocation) {
