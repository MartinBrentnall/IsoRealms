...
namespace IsoRealms::Hue {
  ...
  class HueManager {
    private:
    static const std::string TAG_BULB;
      
    static const std::string ATTRIBUTE_BRIDGE_ADDRESS;
    static const std::string ATTRIBUTE_BRIDGE_USER;
    static const std::string ATTRIBUTE_BRIDGE_PSK;
    static const std::string ATTRIBUTE_BULB_ID;
    static const std::string ATTRIBUTE_BULB_COLOUR;
    ...
    class Bulb {
      ...
      public:
      Bulb(HueManager* parent, DOMNode& node, IProject* project, int id);
     ...
     * Resource Interface *
    \**********************/
    HueManager(IProject* project, Hue* hue);
    HueManager(IProject* project, Hue* hue, DOMNode& node, IOptions* options, IResourceData* data);
