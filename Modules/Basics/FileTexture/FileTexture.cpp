...
namespace IsoRealms::Basics {
  ...
  std::vector<std::unique_ptr<IProperty>> FileTexture::getProperties(IPropertyOwner& owner) {
  ...
  std::vector<std::unique_ptr<IProperty>> FileTexture::getAssetProperties(IPropertyOwner& owner) {
