...
namespace IsoRealms::Basics {
  ...
  std::vector<std::unique_ptr<IProperty>> SimpleFloat::getProperties(IResourceData& owner) {
    ...
    mProperties.emplace_back(std::make_unique<PropertyNativeFloat>(owner.getPropertyData("Value"), [this]() {return cDefValue;}, [this](float value) {cDefValue = value; return true;}));
    return mProperties;
  }
