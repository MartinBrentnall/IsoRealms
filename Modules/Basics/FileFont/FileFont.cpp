...
namespace IsoRealms::Basics {
  ...
  std::vector<std::unique_ptr<IProperty>> FileFont::getProperties(IPropertyOwner& owner) {
    ...
    mProperties.emplace_back(std::make_unique<PropertyNativeFloat>(  owner.getPropertyData("Y Offset"),     [this]() {return cDefOffsetY;},     [this](float value) {cDefOffsetY     = value; return true;}));
    mProperties.emplace_back(std::make_unique<PropertyNativeFloat>(  owner.getPropertyData("Line Spacing"), [this]() {return cDefLineSpacing;}, [this](float value) {cDefLineSpacing = value; return true;}));
    return mProperties;
  }
