...
namespace IsoRealms::Basics {
  ...
  void ArgumentDefinition::getProperties(IPropertyMaker& owner, const Metadata& metadata, Function& parent) {
    ...
    owner.createPropertyTreeSelector("ArgumentType",    cDefType);
    owner.createPropertyNativeString("ArgumentLuaName", [this]() {return cDefLuaName;}, [this](const std::string& value) {cDefLuaName = value;});
  }
