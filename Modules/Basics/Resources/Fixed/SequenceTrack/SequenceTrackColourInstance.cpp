...
namespace IsoRealms::Basics {
  ...
  void SequenceTrackColourInstance::publish(ResourcePublisher& publisher, const std::string& parentID) {
    cStateNotifier = publisher.publish<IColour>(this, parentID + "/" + cParent.getName(), "Colours animated from Sequences"); // TODO: Localize this.
  }
  ...
  void SequenceTrackColourInstance::updateColour() {
    ...
    if (cRuntimeColour != mPreviousColour && cStateNotifier != nullptr) { // TODO: State notifier should never be nullptr!!!  Need to make sure "publish" is called after adding a track in editor.
