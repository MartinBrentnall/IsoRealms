...
namespace IsoRealms::Basics {
  ...
  void SequenceTrackFloatInstance::publish(ResourcePublisher& publisher, const std::string& parentID) {
    cStateNotifier = publisher.publish<IFloat>(this, parentID + "/" + cParent.getName(), "Sequences");
  }
