...
namespace IsoRealms::Basics {
  ...
  void SequenceTrackScreenInstance::publish(ResourcePublisher& publisher, const std::string& parentID) {
    publisher.publish<IScreen>(this, parentID + "/" + cParent.getName(), "Sequences");
  }
