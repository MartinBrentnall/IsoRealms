...
DialogColourFixed::DialogColourFixed(IEditingContext* editingContext, Colour* colour, IResourceAccessor* resources, const std::string& resourceName) : DialogOKCancelUndo(editingContext, resources, "Colour", resourceName) {
  ...
  addComponent("content", cColourSelector);
}
