...
SpindizzyLift::SpindizzyLift(ISpindizzyLiftType* elementType, BlockLocation* location, I3DModelFactory* modelType, SpindizzyLiftProperties* properties, int bottom, int top) : Element<ISpindizzyLiftSet, ISpindizzyLiftType>(elementType) {
...
void SpindizzyLift::save(DOMNodeWriter* node, IResourceLocator* resourceLocator, BlockLocation& relative) {
