 ...
 */
#ifndef DIALOG_VERTEX_MANAGER_H
#define DIALOG_VERTEX_MANAGER_H
...
class DialogVertexManager:public Dialog,
                          public IProjectManagerListener {
  private:
  ComponentResourceBrowser<IVertex, NamedResourceIcon<IVertex> >* cVertexBrowser;
    
  public:
  DialogVertexManager(IComponentContainer*, IResourceAccessor*, IResourceManager*, IProjectManager*, IResourceLocator*, IEditingContext*);
