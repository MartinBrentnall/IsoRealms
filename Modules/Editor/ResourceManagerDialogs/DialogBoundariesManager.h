 ...
 */
#ifndef DIALOG_BOUNDARIES_MANAGER_H
#define DIALOG_BOUNDARIES_MANAGER_H
...
class DialogBoundariesManager:public Dialog,
                              public IProjectManagerListener {
  private:
  ComponentResourceBrowser<IBoundaries, NamedResourceIcon<IBoundaries> >* cBoundariesBrowser;
    
  public:
  DialogBoundariesManager(IComponentContainer*, IResourceAccessor*, IResourceManager*, IProjectManager*, IResourceLocator*, IEditingContext*);
