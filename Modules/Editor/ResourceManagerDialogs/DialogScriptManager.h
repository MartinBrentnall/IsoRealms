 ...
 */
#ifndef DIALOG_SCRIPT_MANAGER_H
#define DIALOG_SCRIPT_MANAGER_H
...
class DialogScriptManager:public Dialog,
                          public IProjectManagerListener {
  private:
  ComponentResourceBrowser<IScript, NamedResourceIcon<IScript> >* cScriptBrowser;
    
  public:
  DialogScriptManager(IComponentContainer*, IResourceAccessor*, IResourceManager*, IProjectManager*, IResourceLocator*, IEditingContext*);
