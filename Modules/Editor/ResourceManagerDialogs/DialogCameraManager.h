 ...
 */
#ifndef DIALOG_CAMERA_MANAGER_H
#define DIALOG_CAMERA_MANAGER_H
...
class DialogCameraManager:public Dialog,
                          public IProjectManagerListener {
  private:
  ComponentResourceBrowser<ICamera, NamedResourceIcon<ICamera> >* cCameraBrowser;
    
  public:
  DialogCameraManager(IComponentContainer*, IResourceAccessor*, IResourceManager*, IProjectManager*, IResourceLocator*, IEditingContext*);
