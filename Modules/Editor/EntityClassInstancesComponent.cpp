...
EntityClassInstancesComponent::EntityClassInstancesComponent(IEntityClass* entityClass, IComponentContainer* componentContainer, IInstanceSelectionListener* listener, IResourceAccessor* resources) : ResizableDialog(componentContainer, "Engine/Default/ControlLoop/SimpleEditor/EntityClassInstances", resources) {
...
void EntityClassInstancesComponent::CreateInstanceCommand::execute() {
  ...
  std::cout << "Creating instance \"" << mImplementation << "\"..." << std::endl;
  cParent->cEntityClass->instantiate(mImplementation);
