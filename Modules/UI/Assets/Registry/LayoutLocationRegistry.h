...
#include "Modules/UI/Assets/Fixed/LayoutLocation/LayoutLocationAbsolute.h"
#include "Modules/UI/Assets/Fixed/LayoutLocation/LayoutLocationRelative.h"
...
namespace IsoRealms::UI {
  ...
  class LayoutLocationRegistry : public AssetClientManager<LayoutLocationRegistry, LayoutComponentEdge, ILayoutLocation> {
    ...
    AssetInstanced<LayoutComponentEdge, ILayoutLocation, LayoutLocationRelative> cRelative;
  };
}
