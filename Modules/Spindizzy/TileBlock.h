...
class TileBlock {
  ...
  IGeometricElement* cTopGeometricElement;
  IGeometricElement* cBottomGeometricElement;
  int cTop;
  int cBottom;
  bool cTopExtended;
  ...
  public:
  TileBlock(IGeometricElement*, int, int, bool, bool);
  ...
  IGeometricElement* getGeometricElement(ITileSurface::FaceDirection);
