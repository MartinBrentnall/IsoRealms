...
ModelSpindizzyCraftPyramid::ModelSpindizzyCraftPyramid(Vertex* location, Texture** textureTop, Texture** textureSide) {
  cTextureTop = textureTop;
  cTextureSide = textureSide;
  cLocation = location;
}

void ModelSpindizzyCraftPyramid::update(unsigned int milliseconds) {
  // Nothing to do
}

void ModelSpindizzyCraftPyramid::render() {
