...
class ResourceElementSpindizzyBlock;
...
class SpindizzyBlockConfigurationComponent:public Dialog {
  ...
  ResourceElementSpindizzyBlock* cBlockType;
  ...
  public:
  SpindizzyBlockConfigurationComponent(IComponentContainer*, ResourceElementSpindizzyBlock*, SpindizzyBlockProperties*, IComponentCloseListener*);
