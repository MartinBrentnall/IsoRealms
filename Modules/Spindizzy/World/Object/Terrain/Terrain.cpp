...
namespace IsoRealms::Spindizzy {
  ...
  Terrain::Terrain(Zone& zone, JSONObject object) :
    ...
    cZone.getWorld().getSpindizzy().getProject().init([this, object]() {
      cDefType = cZone.getWorld().getSpindizzy().get<TerrainType>(nullptr, object.getString(JSON_TYPE));
  ...
  int Terrain::getXSlope() const {
    return Spindizzy::getTerrainSlope(cDefCornerHeight[0][1], cDefCornerHeight[0][0], cDefCornerHeight[1][1], cDefCornerHeight[1][0]);
  }

  int Terrain::getYSlope() const {
    return Spindizzy::getTerrainSlope(cDefCornerHeight[0][0], cDefCornerHeight[1][0], cDefCornerHeight[0][1], cDefCornerHeight[1][1]);
  }
