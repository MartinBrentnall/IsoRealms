...
#include "Modules/Spindizzy/TerrainState/TerrainState.h"
#include "Modules/Spindizzy/ThemeSet/Theme.h"
#include "Modules/Spindizzy/ThemeSet/ThemeSet.h"
...
namespace IsoRealms::Spindizzy {
  ...
  class Zone : public IBoundary,
    ...
    void spindizzyZoneThemeEdited(Theme* theme);
    Theme* getTheme();
