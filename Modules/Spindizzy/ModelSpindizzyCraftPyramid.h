 ...
 */
#ifndef MODEL_SPINDIZZY_CRAFT_PYRAMID_H
#define MODEL_SPINDIZZY_CRAFT_PYRAMID_H
...
class ModelSpindizzyCraftPyramid:public I3DModel {
  private:
  Texture** cTextureTop;
  ...
  public:
  ModelSpindizzyCraftPyramid(Vertex*, Texture**, Texture**);
