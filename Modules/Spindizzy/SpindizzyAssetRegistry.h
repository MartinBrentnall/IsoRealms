...
namespace IsoRealms::Spindizzy {
  using AssetVariant = std::variant<IBoundaryType*,
                                    ...
                                    IZoneViewType*>;
  class SpindizzyAssetRegistry : public AbstractAssetRegistry<AssetVariant, Spindizzy> {
    public:
    SpindizzyAssetRegistry(Spindizzy& spindizzy) :
              AbstractAssetRegistry<AssetVariant, Spindizzy>(spindizzy) {
    }
  };
}
