...
SpindizzyJewelModel::SpindizzyJewelModel(Vertex* location, float scale, std::vector<IColour*>* coloursCycle, IColour** colourFrame) {
...
void SpindizzyJewelModel::refresh() {
...
void SpindizzyJewelModel::update(unsigned int milliseconds) {
