...
void BlockSubtractor::save(DOMNodeWriter* node, IResourceLocator* resourceLocator) {
  node->addAttribute("removeHiddenSurfaces", cRemoveHiddenSurfaces ? "true" : "false");
  node->addAttribute("useAdjacentZones", cUseAdjacentZones ? "true" : "false");
}
...
extern "C" IPlugin* create() {
  return new SingleResourceTypeModule<BlockSubtractor>("SurfaceProcessor");
}
