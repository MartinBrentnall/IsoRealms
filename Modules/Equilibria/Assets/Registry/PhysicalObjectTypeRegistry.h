...
namespace IsoRealms::Equilibria {
  ...
  class PhysicalObjectTypeRegistry : public AssetClientManager<PhysicalObjectTypeRegistry, Equilibria, IPhysicalObjectType> {
    public:
    ...
    AssetLiteralDummy<Equilibria, IPhysicalObjectType, Dummy> cDummy;
  };
}
