...
#include "Modules/Equilibria/World/Object/ZoneObject/Traits/Model/Model.h"
...
namespace IsoRealms::Equilibria {
  ...
  void ZoneObjectTypeTraitModel::registerAssets(EquilibriaAssetRegistry& assets, const std::string& parentID) {
    // Nothing to do.
  }
  ...
  void ZoneObjectTypeTraitModel::getAssetProperties(IPropertyMaker& owner) {
    // Nothing to do.
  }
