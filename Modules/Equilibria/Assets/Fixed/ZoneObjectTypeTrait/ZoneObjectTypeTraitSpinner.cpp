...
#include "Modules/Equilibria/World/Object/ZoneObject/Traits/Spinner/Spinner.h"
...
namespace IsoRealms::Equilibria {
  ...
  void ZoneObjectTypeTraitSpinner::registerAssets(EquilibriaAssetRegistry& assets, const std::string& parentID) {
    // Nothing to do.
  }
