...
namespace IsoRealms::Equilibria {
  ...
  class BoundaryTypeRegistry : public ResourceClientManager<BoundaryTypeRegistry, Equilibria, IBoundaryType> {
    public:
    ...
    ResourceLiteralDummy<Equilibria, IBoundaryType, Dummy> cDummy;
  };
}
