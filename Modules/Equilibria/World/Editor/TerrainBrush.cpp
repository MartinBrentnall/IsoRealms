...
namespace IsoRealms::Equilibria {
  ...
  int TerrainBrush::getXSlope() const {
    return Equilibria::getTerrainSlope(cCornerHeight[0][1].value(), cCornerHeight[0][0].value(), cCornerHeight[1][1].value(), cCornerHeight[1][0].value());
  }

  int TerrainBrush::getYSlope() const {
    return Equilibria::getTerrainSlope(cCornerHeight[0][0].value(), cCornerHeight[1][0].value(), cCornerHeight[0][1].value(), cCornerHeight[1][1].value());
  }
  ...
  float TerrainBrush::getXSlopeAnimation() const {
    return Equilibria::getTerrainSlope(cCornerHeight[0][1].animation(), cCornerHeight[0][0].animation(), cCornerHeight[1][1].animation(), cCornerHeight[1][0].animation());
  }

  float TerrainBrush::getYSlopeAnimation() const {
    return Equilibria::getTerrainSlope(cCornerHeight[0][0].animation(), cCornerHeight[1][0].animation(), cCornerHeight[0][1].animation(), cCornerHeight[1][1].animation());
  }
