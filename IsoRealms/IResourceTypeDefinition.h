...
namespace IsoRealms {
  ...
  class IResourceTypeDefinition {
    ...
    virtual IResource* loadResource(IResourceType& parent, IProject& project, JSONObject object, IOptions& options, ProjectFile* ownerProject, const std::string& resourceDataPath) = 0;
