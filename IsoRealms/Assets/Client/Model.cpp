...
namespace IsoRealms {
  ...
  std::vector<std::unique_ptr<IProperty>> Model::getClientProperties() {
    ...
    mProperties.emplace_back(std::make_unique<PropertyNativeFloat>(PropertyData("Offset X", "TODO"), [this]() {return cDefOffsetX;}, [this](float value) {cDefOffsetX = value; return true;}));
    mProperties.emplace_back(std::make_unique<PropertyNativeFloat>(PropertyData("Offset Y", "TODO"), [this]() {return cDefOffsetY;}, [this](float value) {cDefOffsetY = value; return true;}));
    mProperties.emplace_back(std::make_unique<PropertyNativeFloat>(PropertyData("Offset Z", "TODO"), [this]() {return cDefOffsetZ;}, [this](float value) {cDefOffsetZ = value; return true;}));
    mProperties.emplace_back(std::make_unique<PropertyNativeFloat>(PropertyData("Scale X",  "TODO"), [this]() {return cDefScaleX;},  [this](float value) {cDefScaleX  = value; return true;}));
    mProperties.emplace_back(std::make_unique<PropertyNativeFloat>(PropertyData("Scale Y",  "TODO"), [this]() {return cDefScaleY;},  [this](float value) {cDefScaleY  = value; return true;}));
    mProperties.emplace_back(std::make_unique<PropertyNativeFloat>(PropertyData("Scale Z",  "TODO"), [this]() {return cDefScaleZ;},  [this](float value) {cDefScaleZ  = value; return true;}));
    mProperties.emplace_back(std::make_unique<PropertyNativeFloat>(PropertyData("Angle",    "TODO"), [this]() {return cDefYaw;},     [this](float value) {cDefYaw     = value; return true;}));
    mProperties.emplace_back(std::make_unique<PropertyNativeFloat>(PropertyData("Tilt",     "TODO"), [this]() {return cDefPitch;},   [this](float value) {cDefPitch   = value; return true;}));
    return mProperties;
  }
