...
#include "Registry/ColourRegistry.h"
#include "Registry/EditableRegistry.h"
#include "Registry/FloatRegistry.h"
#include "Registry/FontRegistry.h"
#include "Registry/InputHandlerRegistry.h"
#include "Registry/IntegerRegistry.h"
#include "Registry/ModelRegistry.h"
#include "Registry/ScreenRegistry.h"
#include "Registry/StringRegistry.h"
...
namespace IsoRealms {
  ...
  class Project : public IResourceData,
    ...
    template <typename TYPE> void forEachEntry(std::function<void(const AssetInfo&)> getAssetInfoFunction) const {
      AssetContainerTraits<TYPE>::get(*this).forEachEntry(getAssetInfoFunction);
    }
