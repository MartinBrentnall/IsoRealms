...
class IResources {
  ...
  virtual ISound* getSound(DOMNodeWrapper*) = 0;
  virtual ILuaFunctionArgument* getArgument(DOMNodeWrapper*) = 0;
  ...
  virtual void add(ISound*, std::vector<std::string>, std::string) = 0;
  virtual void add(IInteger*, std::vector<std::string>, std::string) = 0;
};
