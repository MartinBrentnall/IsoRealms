 ...
 */
#include "ComponentIconTexture.h"

ComponentIconTexture::ComponentIconTexture(ITexture* texture) {
  cTexture = texture;
}

float ComponentIconTexture::getWidth() {
...
float ComponentIconTexture::getHeight() {
  return 0.1f;
}

void ComponentIconTexture::render() {
  cTexture->set();
  float mLeft = getLeft();
...
void ComponentIconTexture::update(unsigned int milliseconds) {
  // Nothing to do
}

bool ComponentIconTexture::input(SDL_Event& event) {
  return false;
}
