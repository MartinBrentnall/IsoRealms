...
void RuntimeContext::add(I3DModelFactory* modelType,                  const std::string& name, DOMNodeWrapper* node) {cResources->add(modelType,           cEntityPath, name, node);}
...
void RuntimeContext::add(ICollectables* collectables,                 const std::string& name, DOMNodeWrapper* node) {cResources->add(collectables,        cEntityPath, name, node);}
void RuntimeContext::add(ICollidableSurfaceRegistry* surfaceRegistry, const std::string& name, DOMNodeWrapper* node) {cResources->add(surfaceRegistry,     cEntityPath, name, node);}
...
void RuntimeContext::add(IHUDComponentFactory* type,                  const std::string& name, DOMNodeWrapper* node) {cResources->add(type,                cEntityPath, name, node);}
void RuntimeContext::add(IInteger* value,                             const std::string& name, DOMNodeWrapper* node) {cResources->add(value,               cEntityPath, name, node);}
void RuntimeContext::add(IMap* map,                                   const std::string& name, DOMNodeWrapper* node) {cResources->add(map,                 cEntityPath, name, node);}
...
void RuntimeContext::add(ISurfaceProcessor* surfaceProcessor,         const std::string& name, DOMNodeWrapper* node) {cResources->add(surfaceProcessor,    cEntityPath, name, node);}
...
void RuntimeContext::add(IVertex* location,                           const std::string& name                      ) {cResources->add(location,            cEntityPath, name);}
void RuntimeContext::add(IZoneHandler* zoneHandler,                   const std::string& name, DOMNodeWrapper* node) {cResources->add(zoneHandler,         cEntityPath, name, node);}
