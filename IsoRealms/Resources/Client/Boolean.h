...
namespace IsoRealms {
  class Boolean : public Resource<Boolean, IBoolean, IComponentData>,
                  public IStateListener {
    public:
    Boolean(IComponentData& owner, bool defaultValue = false, std::function<void(bool)> listener = nullptr);

    /*************************************************\
     * Implements Resource<IBoolean, IComponentData> *
    \*************************************************/
    IBoolean* createDefaultResource(IComponentData& owner);
