...
namespace IsoRealms {
  class Colour : public Resource<Colour, IColour, IComponentData>,
    ...
    /********************************************************\
     * Implements Resource<Colour, IColour, IComponentData> *
    \********************************************************/
    IColour* createDefaultResource(IComponentData& owner);
