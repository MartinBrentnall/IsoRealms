 ...
 */
#ifndef ARGUMENT_DEFINITION_REFERENCE_H
#define ARGUMENT_DEFINITION_REFERENCE_H
...
class ArgumentDefinitionReference:public IArgumentDefinition {
  private:
  ...
  public:
  ArgumentDefinitionReference(DOMNodeWrapper*, const std::string*, IResourceRegistry*);
