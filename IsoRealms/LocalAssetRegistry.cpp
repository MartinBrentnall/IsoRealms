...
namespace IsoRealms {
  ...
  void                      LocalAssetRegistry::add(I3DModelType*    asset, const std::string& id, const std::string& category) {       cAssetRegistry->add(asset, id == "" ? cLocalPath : cLocalPath + "/" + id, category);}
