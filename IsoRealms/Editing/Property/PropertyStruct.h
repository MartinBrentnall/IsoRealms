...
namespace IsoRealms {
  ...
  class PropertyStruct : public Property {
    public:
    PropertyStruct(PropertyMaker& owner, const PropertyData& data, const std::string& value, std::function<void()> subProperties, std::function<void()> removeFunction = nullptr);
