...
namespace IsoRealms {
  class PropertyRemover : public Property {
    public:
    PropertyRemover(const PropertyData& data, IComponentAccessManager& resourceAccessManager, const std::string& value, std::function<void()> removeFunction);
