...
namespace IsoRealms {
  ...
  class PropertyCondition : public Property {
    public:
    PropertyCondition(const PropertyData& data, IComponentAccessManager& resourceAccessManager, std::vector<ConditionElement*> availableElements, std::function<std::optional<Condition>&()> getter, std::function<void(std::optional<Condition>&)> setter);
