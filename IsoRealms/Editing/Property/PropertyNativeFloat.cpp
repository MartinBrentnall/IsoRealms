...
namespace IsoRealms {
  PropertyNativeFloat::PropertyNativeFloat(const std::string& name, std::function<float()> getter, std::function<bool(float)> setter, std::function<void()> removeFunction) :
