...
namespace IsoRealms {
  class PropertyInputField : public Property {
    public:
    PropertyInputField(const PropertyData& data, IComponentAccessManager& resourceAccessManager, const std::string& value, std::function<void()> removeFunction);
    ...
    class Editor : public IPropertyEditor {
      public:
      Editor(PropertyInputField& parent);
