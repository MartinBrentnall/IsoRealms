...
namespace IsoRealms {
  ...
  class PropertyMaker : public IPropertyMaker {
    ...
    void createPropertyOptional(             const PropertyData& metadata, IOptionalObject& optionalSource, const std::string& noneLabel, std::function<bool()> noneIcon, std::function<void(const std::string&)> choiceCallback) override;
